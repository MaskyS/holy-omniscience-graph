...
## What is [The Information Platform of The Future](<The Information Platform of The Future.md>)?
    ...
    - Some like to call it [Web 3.0](<Web 3.0.md>), but we believe its fundamental differences warrant a new name. And this name includes the word 'platform'-- which literally means "__a raised level surface on which people or things can stand__", not "__big evil tech company__".
    - :hiccup [:hr]
## How to use this graph
    - 
...
## How you can play a part
    ...
    - ## What is [holy omniscience](<holy omniscience.md>)?
        ...
        - For more, see the [holy omniscience](<holy omniscience.md>) page.
        - :hiccup [:hr]
    - 
## Who made this?
